...
export const sanitizeVehicleConfigData = (body) => ({
    ...
    state: sanitizeVehicleConfigInput(body.form_fields?.state || body['form_fields[state]'] || body.state || ''),
    zip: sanitizeVehicleConfigInput(body.zip || ''),
    country: sanitizeVehicleConfigInput(body.form_fields?.country || body['form_fields[country]'] || body.country || ''),
